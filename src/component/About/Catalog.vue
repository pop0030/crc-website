        ...
        div.container
            div.row.catalog-items.no-gutters
                div.col-md-4(v-for="(i, n) in catalogs")
                    div.catalog-item
                        div.cover(:style="{ backgroundImage: `url(${i.cover}` }")
                        div.border-line
                        div.ctx
                            p.name {{i.name}}
                            p.detail {{i.detail}}
...
import catImgs0 from '../../img/catalog-images/victoria-bilsborough-232767.jpg';
import catImgs1 from '../../img/catalog-images/clem-onojeghuo-101919.jpg';
import catImgs2 from '../../img/catalog-images/alex-jones-6798.jpg';
import catImgs3 from '../../img/catalog-images/bobby-hendry-304872.jpg';
import catImgs4 from '../../img/catalog-images/sergey-zolkin-403.jpg';
import catImgs5 from '../../img/catalog-images/rawpixel-com-196509.jpg';
import catImgs6 from '../../img/catalog-images/bench-accounting-49026.jpg';
import catImgs7 from '../../img/catalog-images/markus-spiske-104910.jpg';
import catImgs8 from '../../img/catalog-images/kris-atomic-73935.jpg';
import catImgs9 from '../../img/catalog-images/jakob-owens-335000.jpg';
