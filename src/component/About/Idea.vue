...
#page-Idea
    //- div.row.idea-nav
        div.col-md-3(v-for="(i, n) in ideas" @click="ideaNavClick(n)" :class="{active:i.active}")
            div.bg(:style="coverBg(i.cover)")
            div.ctx
                p.title {{i.title}}
                p.text {{i.subTitle}}
    div.row.idea-part
        div.item.col-md-12(v-for="(i, n) in ideas" v-bind:style="bgImgStyle('url('+i.cover+')')")
            p.title {{i.title}}
            div.ctx(v-bind:eq="n")
                p.sub-title {{i.subTitle}}
                p.text(v-html="nbr(i.text)")
</template>
    ...
    .idea-nav {
        ...
        >div{
            ...
            &.active {
                ...
                div.bg {
                    border-bottom: 10px solid _green-light;
                }
            }
        }
        div.bg {
    ...
    .idea-part {
        ...
        .item {
            ...
            p.title {
                ...
                color: _white;
                margin: 1.5rem 1.5rem 15rem 1.5rem;
                line-height: 1;
            ...
            div.ctx {
                ...
                background-color: alpha(_white, 1);
                width: 100%;
                margin: 0;
                @media (max-width: sm-size) {
                    padding: 1rem;
